/*
 * CallsReceivedVertexSizeFunction.java
 *
 * Author: Pieter Deelen
 * Created: July 14, 2005, 9:45 AM
 *
 */
 ...
 * the class represented by this vertex has received.
 * @author Pieter Deelen
 */
public class CallsReceivedVertexSizeFunction implements VertexSizeFunction {
	/**
	 ...
	 */
	public CallsReceivedVertexSizeFunction() {
	 ...
	 * @param scale the scale to use.
	 */
	public CallsReceivedVertexSizeFunction(int scaleFactor, Scale scale) {
		this.settings = new Settings(scaleFactor, scale);
	}

	/**
	 * Creates a new instance of CallsReceivedVertexSizeFunction with
	 * the specified settings.
	 * @param settings the specified settings.
	 */
	public CallsReceivedVertexSizeFunction(Settings settings) {
	...
	public int getSize(Vertex v) {
		...
		int callCount = classData.getCallsReceived();
	...
	public int getMaxSize(Vertex v) {
		ClassData classData = (ClassData)v.getUserDatum("tracevis.model.Program");
		int callCount = classData.getMaxCallsReceived();
