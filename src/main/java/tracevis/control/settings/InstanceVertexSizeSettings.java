/*
 * InstanceVertexSizeSettings.java
 *
...
/**
 * A configuration panel which allows the user to configure the "instance"
 * vertex size function.
 * @author  Pieter Deelen
 */
public class InstanceVertexSizeSettings extends JPanel {
	/**
	 * Creates new form InstanceVertexSizeSettings.
	 */
	public InstanceVertexSizeSettings(InstanceVertexSizeFunction.Settings settings) {
		initComponents();
	...
	public InstanceVertexSizeFunction.Settings getSettings() {
		...
		return new InstanceVertexSizeFunction.Settings(scaleFactor, scale);
	}
