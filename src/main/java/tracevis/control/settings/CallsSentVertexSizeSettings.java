 ...
 * Created: August 25, 2005, 3:54 AM
 *
 */
...
/**
 * A configuration panel which allows the user to configure the "calls sent"
 * vertex size function.
 * @author Pieter Deelen
 */
public class CallsSentVertexSizeSettings extends JPanel {
	/**
	 * Creates new form CallsSentVertexSizeSettings.
	 */
	public CallsSentVertexSizeSettings(CallsSentVertexSizeFunction.Settings settings) {
		initComponents();
	...
	public CallsSentVertexSizeFunction.Settings getSettings() {
		...
		return new CallsSentVertexSizeFunction.Settings(scaleFactor, scale);
	}
